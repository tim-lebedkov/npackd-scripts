...
set name=QuaZIP-static-i686-w32-0.4.2
...
"%npackd_cl%\npackdcl.exe" add --package=net.sourceforge.quazip.QuaZIPSource --version=0.4.2
if %errorlevel% neq 0 exit /b %errorlevel%
...
set onecmd="%npackd_cl%\npackdcl.exe" path "--package=net.sourceforge.quazip.QuaZIPSource" "--versions=[0.4.2, 0.4.2]"
